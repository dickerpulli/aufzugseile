...
import de.tbosch.aufzugseile.berechnung.treibfaehigkeit.Treibfaehigkeit;
 ...
 */
public class TreibfaehigkeitFrame extends javax.swing.JFrame implements ReactingFrame {
    
    /**
	 * 
	 */
	private static final long serialVersionUID = 1066189403698549292L;
    ...
    public TreibfaehigkeitFrame(MainFrame mainFrame, Treibscheibe treibscheibe, Kabine kabine, Gewicht gewicht, int hoehe, double geschw, int seilcount, double seildurchmesser) {
    	...
    	initComponents();
    	trf = new Treibfaehigkeit(mainFrame);
    	if (trf.setTreibscheibe(treibscheibe) == false) { 
			Constants.LOGGER.warning("setTreibscheibe failed!");
		}
    ...
    public void checkGegengewichtsparameter(Gewicht gewicht) {
    	if (gewicht.getPart() != 0.5) {
    		ErrorFrame errorFrame = new ErrorFrame(this, "Der Gegegenbewichtsparameter ist ungleich '0,5', d.h. nicht mit TRA kompatibel! Ggf. "+Constants.AE_K+"ndern, da sonst Treibf"+Constants.AE_K+"hihkeitsberechnung und Aufzugkonstruktion nicht "+Constants.UE_K+"bereinstimmen.");
    ...
    private void initComponents() {
        ...
        setTitle("Treibf"+Constants.AE_K+"higkeit");
        setResizable(false);
        ...
        jLabel1.setText("Berechnung der Treibf"+Constants.AE_K+"higkeit nach TRA003");
        ...
        jLabel5.setText("H"+Constants.AE_K+"ngekabelgewichtskraft:");
        ...
        jLabel12.setText("Hubh"+Constants.OE_K+"he:");
        ...
        kleingueterRadioButton.setText("Kleing"+Constants.UE_K+"teraufzug");
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(umschlWinkelFormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                                    .addComponent(gewichtkraftFormattedTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                                    ...
                                    .addComponent(seilmasseFormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                                    .addComponent(kabinekraftFormattedTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE)
                                    .addComponent(tskraftFormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, 0, 0, Short.MAX_VALUE)
                                    .addComponent(seilanzahlTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 138, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    .addComponent(phiFormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                                    .addComponent(s2s1FormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                                    .addComponent(t2t1FormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                                    .addComponent(pressungFormattedTextField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void sonstigerRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sonstigerRadioButtonActionPerformed
    	if (sonstigerRadioButton.isSelected()) {
    		trf.refreshTyp(Constants.TYP_SONSTIGER);
			calcButtonActionPerformed(null);
    	}
    ...
    private void fassadeRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fassadeRadioButtonActionPerformed
    	if (fassadeRadioButton.isSelected()) {
    		trf.refreshTyp(Constants.TYP_FASSADE);
			calcButtonActionPerformed(null);
    	}
    ...
    private void kleingueterRadioButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kleingueterRadioButtonActionPerformed
    	if (kleingueterRadioButton.isSelected()) {
    		trf.refreshTyp(Constants.TYP_KLEINLAST);
			calcButtonActionPerformed(null);
    	}
    ...
    private void calcButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_calcButtonActionPerformed
		...
		if (t2t1 >= s2s1 * phi) {
			ergLabel.setText("Erf"+Constants.UE_K+"llt");
			ergPanel.setBackground(Color.GREEN);
			TSphiIO = true;
		}
		else {
			ergLabel.setText("Nicht erf"+Constants.UE_K+"llt");
