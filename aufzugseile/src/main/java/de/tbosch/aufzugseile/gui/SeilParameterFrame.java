 ...
 * @author schulung
 */
public class SeilParameterFrame extends javax.swing.JFrame implements ReactingFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = 9069156524085296492L;
	...
	private void initComponents() {
		...
		parameterTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
				{ Boolean.valueOf(true), "8x19S-FE sZ", new Double(-2.611), new Double(-2.927), new Double(1.887), new Double(8.567), new Double(-0.32),
						new Double(-2.894), new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x19S-FE zZ", new Double(-2.388), new Double(-2.704), new Double(1.887), new Double(8.567), new Double(-0.32), new Double(-2.894),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x19S-SES sZ", new Double(-2.148), new Double(-2.534), new Double(1.588), new Double(8.056), new Double(-0.32), new Double(-2.577),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) },
				{ null, "8x19S-SES zZ", new Double(-2.088), new Double(-2.474), new Double(1.588), new Double(8.056), new Double(-0.32), new Double(-2.577),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) },
				{ Boolean.valueOf(true), "8x19F/W-FE sZ", new Double(-2.476), new Double(-2.792), new Double(1.887), new Double(8.567), new Double(-0.32),
						new Double(-2.894), new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x19F/W-FE zZ", new Double(-2.253), new Double(-2.569), new Double(1.887), new Double(8.567), new Double(-0.32), new Double(-2.894),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x19F/W-SES sZ", new Double(-2.015), new Double(-2.401), new Double(1.588), new Double(8.056), new Double(-0.32), new Double(-2.577),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) },
				{ null, "8x19F/W-SES zZ", new Double(-1.955), new Double(-2.341), new Double(1.588), new Double(8.056), new Double(-0.32), new Double(-2.577),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) },
				{ Boolean.valueOf(true), "8x36WS-FE sZ", new Double(-1.302), new Double(-1.618), new Double(1.322), new Double(8.07), new Double(-0.32),
						new Double(-2.649), new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x36WS-FE zZ", new Double(-1.194), new Double(-1.51), new Double(1.322), new Double(8.07), new Double(-0.32), new Double(-2.649),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.35), new Double(1770.0) },
				{ null, "8x36WS-SES sZ", new Double(0.633), new Double(0.247), new Double(0.377), new Double(6.232), new Double(-0.32), new Double(-1.75),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) },
				{ null, "8x36WS-SES zZ", new Double(0.687), new Double(0.301), new Double(0.377), new Double(6.232), new Double(-0.32), new Double(-1.75),
						new Double(1.2), new Double(1.9), new Double(1.0), new Double(0.42), new Double(1770.0) } }, new String[] { "", "Seiltyp", "b0 / N A",
				"b0 / N A10", "b1", "b2", "b3", "b4", "b5 / N A", "b5 / N A10", "fn2", "kg/100m/mm²", "N/mm²" }) {
			@SuppressWarnings("unchecked")
			Class[] types = new Class[] { java.lang.Boolean.class, java.lang.String.class, java.lang.Double.class, java.lang.Double.class,
		...
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addGroup(
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE,
								924, Short.MAX_VALUE).addGroup(
								layout.createSequentialGroup().addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(jLabel1).addGroup(
												layout.createSequentialGroup().addGap(12, 12, 12).addComponent(hinzuButton).addGap(6, 6, 6).addComponent(
														entfButton).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
														resetButton).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(
														saveButton).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
														.addComponent(loadButton))).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 208,
										Short.MAX_VALUE)).addGroup(
								javax.swing.GroupLayout.Alignment.TRAILING,
								layout.createSequentialGroup().addComponent(okButton).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
		...
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addContainerGap().addComponent(jLabel1).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 266, javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.RELATED).addGroup(
								layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(hinzuButton).addComponent(entfButton)
										.addComponent(resetButton).addComponent(saveButton).addComponent(loadButton)).addPreferredGap(
								javax.swing.LayoutStyle.ComponentPlacement.RELATED, 28, Short.MAX_VALUE).addGroup(
	...
	private void resetButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_resetButtonActionPerformed
		if (dialogFrame == null || !dialogFrame.isShowing()) {
			dialogFrame = new DialogFrame(this, "M" + Constants.OE_K + "chten Sie die vorgegebenen Seilparameter wiederherstellen?", Constants.DIALOG_RESET,
					false);
			Helper.showFrame(dialogFrame, this);
		}
	...
	private void okButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_okButtonActionPerformed
		...
		try {
			...
			Constants.LOGGER.log(Level.SEVERE, "File " + Constants.SEIL_FILENAME + " can not be set writable! Error in saving!");
	...
	public void okClicked(JFrame child) {
		...
		if (child.getName().equals(Constants.DIALOG_REMOVE)) {
			DefaultTableModel model = (DefaultTableModel) parameterTable.getModel();
			if (parameterTable.getSelectedRow() != -1)
				model.removeRow(parameterTable.getSelectedRow());
