...
public class RollenParameterPanel extends javax.swing.JPanel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8431574515863046262L;
     ...
     */
    public RollenParameterPanel(Rolle rolle, MainFrame mainFrame) {
		...
		lockToggleButton.setSelectedIcon(new ImageIcon(Helper.getFileURL(Constants.LOCKED_ICON)));
		lockToggleButton.setIcon(new ImageIcon(Helper.getFileURL(Constants.UNLOCKED_ICON)));
    ...
    private void initComponents() {
        ...
        schraegzugLabel.setText("Schrägzug (fn4):");
    ...
    private void durchmesserFormattedTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_durchmesserFormattedTextFieldKeyReleased
    	try {
			...
			if (rolle.isPartOfDoppelUmlenkrolle()) {
				...
				rolle.getParentDoubleRoll().refreshSize();
			}
			mainFrame.parameterChanged();
		}
		catch (ParseException e) {
