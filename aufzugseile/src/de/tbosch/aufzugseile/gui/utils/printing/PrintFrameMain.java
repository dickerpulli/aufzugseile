...
public class PrintFrameMain extends JFrame implements Printable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2009357158952360704L;
	...
	private void initComponents() {
		...
		jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(Messages.getString("PrintFrameMain.4")));

		javax.swing.GroupLayout jPanel1Layout = new javax.swing.GroupLayout(jPanel1);
		jPanel1.setLayout(jPanel1Layout);
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(bezeichnungLabel,
				javax.swing.GroupLayout.DEFAULT_SIZE, 518, Short.MAX_VALUE));
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				jPanel1Layout.createSequentialGroup().addComponent(bezeichnungLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 12, Short.MAX_VALUE)
						.addContainerGap()));

		javax.swing.GroupLayout ooPanelLayout = new javax.swing.GroupLayout(ooPanel);
		ooPanel.setLayout(ooPanelLayout);
		ooPanelLayout.setHorizontalGroup(ooPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				javax.swing.GroupLayout.Alignment.TRAILING,
				ooPanelLayout.createSequentialGroup().addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
						Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(jLabel1)));
		ooPanelLayout.setVerticalGroup(ooPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(
						ooPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false).addComponent(jPanel1,
								javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(jLabel1,
		...
		olPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(Messages.getString("PrintFrameMain.5")));
		...
		orPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(Messages.getString("PrintFrameMain.6")));
		orPanel.setLayout(new java.awt.GridLayout(1, 0));

		jScrollPane1.setBackground(new java.awt.Color(255, 255, 255));

		globalTable.setFont(new java.awt.Font("Dialog", 0, 10));
		globalTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] { { null, null }, { null, null }, { null, null }, { null, null },
				{ null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null },
				{ null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null },
				{ null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null }, { null, null },
				{ null, null }, { null, null }, { null, null }, { null, null }, { null, null } }, new String[] { Messages.getString("PrintFrameMain.8"),
				Messages.getString("PrintFrameMain.9") }) {
		...
		uoPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(Messages.getString("PrintFrameMain.12")));
		...
		uuPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(Messages.getString("PrintFrameMain.13")));
		...
		mainPanelLayout.setHorizontalGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(ooPanel,
				javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE).addComponent(uuuPanel,
				javax.swing.GroupLayout.DEFAULT_SIZE, 540, Short.MAX_VALUE).addComponent(mainSplitPane, javax.swing.GroupLayout.Alignment.TRAILING,
				javax.swing.GroupLayout.DEFAULT_SIZE, 540, Short.MAX_VALUE));
		mainPanelLayout.setVerticalGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				mainPanelLayout.createSequentialGroup().addComponent(ooPanel, javax.swing.GroupLayout.PREFERRED_SIZE, 49,
						javax.swing.GroupLayout.PREFERRED_SIZE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(mainSplitPane,
						javax.swing.GroupLayout.DEFAULT_SIZE, 675, Short.MAX_VALUE).addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
						.addComponent(uuuPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE,
								javax.swing.GroupLayout.PREFERRED_SIZE)));

		javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
		getContentPane().setLayout(layout);
		layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(mainPanel,
				javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addComponent(mainPanel,
				javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
	...
	private void refreshSizes(Aufzugschacht aufzugschacht) {
		for (Umlenkrolle rolle : aufzugschacht.getUmlenkrollenVector()) {
			rolle.refreshSize();
		}
	}
	...
	/**
	 * Creates the tool tips for the copied elevator to see the names of the rolls.
	 * 
	 * @param aschacht
	 *            the copied elevator
	 * @param aufzugschacht
	...
	private void createToolTips(Aufzugschacht aschacht, Aufzugschacht aufzugschacht) {
		if (aufzugschacht.getTreibscheibe() != null) {
			...
			if (tr.isDoppelteUmschlingung())
				name += tr.getRolle2teUmschlingung().getName() + tr.getRolle2teUmschlingung().getID();
			treibscheibeToolTip.setElement(aschacht.getTreibscheibe(), name);
			aschacht.add(treibscheibeToolTip);
		}
		for (int i = 0; i < aufzugschacht.getUmlenkrollenVector().size(); i++) {
			Umlenkrolle rolle = aufzugschacht.getUmlenkrollenVector().get(i);
			MyToolTip rolleToolTip = new MyToolTip(aschacht);
			rolleToolTip.setElement(aschacht.getUmlenkrollenVector().get(i), rolle.getToolTipText());
			// only tooltip for activated rolls
			if (rolle.isActivated())
				aschacht.add(rolleToolTip);
		}
		if (aufzugschacht.getKabinenRolle() != null) {
			Umlenkrolle rolle = aufzugschacht.getKabinenRolle();
			MyToolTip treibscheibeToolTip = new MyToolTip(aschacht);
			treibscheibeToolTip.setElement(aschacht.getKabinenRolle(), rolle.getName() + rolle.getID());
			aschacht.add(treibscheibeToolTip);
		}
		if (aufzugschacht.getGewichtsRolle() != null) {
			Umlenkrolle rolle = aufzugschacht.getGewichtsRolle();
			MyToolTip treibscheibeToolTip = new MyToolTip(aschacht);
			treibscheibeToolTip.setElement(aschacht.getGewichtsRolle(), rolle.getName() + rolle.getID());
			aschacht.add(treibscheibeToolTip);
		}
		if (aufzugschacht.getKabinenDoppelRolle() != null) {
			DoppelUmlenkrolle rolle = aufzugschacht.getKabinenDoppelRolle();
			MyToolTip treibscheibeToolTip = new MyToolTip(aschacht);
			treibscheibeToolTip.setElement(aschacht.getKabinenDoppelRolle(), rolle.getToolTipText());
			aschacht.add(treibscheibeToolTip);
		}
		...
		for (int r = 0; r < oldTable.getRowCount() + 1; r++) {
			for (int s = 0; s < oldTable.getColumnCount(); s++) {
				if (r == 0) {
					...
					if (s == 0) {
						if (r == 1)
							objects[r - 1][s] = "N A"; //$NON-NLS-1$
						if (r == 2)
							objects[r - 1][s] = "N A10"; //$NON-NLS-1$
						if (r == 3)
							objects[r - 1][s] = Messages.getString("PrintFrameMain.77"); //$NON-NLS-1$
					} else
						objects[r - 1][s] = oldTable.getValueAt(r - 1, s);
				}
			}
		}
	...
	private void createAndFillRollenTable(Aufzugschacht aufzugschacht) {
			...
			for (int i = 0; i < aufzugschacht.getSeil().getElementVector().size(); i++) {
				if (aufzugschacht.getSeil().getElementVector().get(i) instanceof Umlenkrolle
					...
					if (alreadyListed.contains(rolle)) {
						Constants.LOGGER.fine(rolle.getName() + rolle.getID() + " already listed. Seems do be a roll with a double enlancement."); //$NON-NLS-1$
				...
				if (aufzugschacht.getSeil().getElementVector().get(i) instanceof DoppelUmlenkrolle) {
					...
					if (alreadyListed.contains(doppelRolle.getRolle1())) {
						Constants.LOGGER.severe(doppelRolle.getRolle1().getName() + " already listed. Should not be!"); //$NON-NLS-1$
					}
					if (alreadyListed.contains(doppelRolle.getRolle2())) {
						Constants.LOGGER.severe(doppelRolle.getRolle2().getName() + " already listed. Should not be!"); //$NON-NLS-1$
					}
		...
		for (int r = 0; r < 5; r++) {
			...
			if (r == 0)
				rowData.add(Messages.getString("PrintFrameMain.29")); //$NON-NLS-1$
			if (r == 1)
				rowData.add("fs2"); //$NON-NLS-1$
			if (r == 2)
				rowData.add("fn3"); //$NON-NLS-1$
			if (r == 3)
				rowData.add("fn4"); //$NON-NLS-1$
			if (r == 4)
				rowData.add(Messages.getString("PrintFrameMain.33")); //$NON-NLS-1$
			if (aufzugschacht.getSeil() != null) {
				for (int i = 0; i < aufzugschacht.getSeil().getElementVector().size(); i++) {
					if (aufzugschacht.getSeil().getElementVector().get(i) instanceof Umlenkrolle) {
						Rolle rolle = (Rolle) aufzugschacht.getSeil().getElementVector().get(i);
						...
						if (r == 0)
							rowData.add(rolle.getDurchmesser());
						if (r == 1)
							rowData.add(rolle.getFs2());
						if (r == 2)
							rowData.add(rolle.getFn3());
						if (r == 3)
							rowData.add(rolle.getFn4());
						if (r == 4)
							rowData.add(rolle.isGegenbiegung());
						alreadyListed.add(rolle);
					}
					if (aufzugschacht.getSeil().getElementVector().get(i) instanceof DoppelUmlenkrolle) {
						...
						if (alreadyListed.contains(rolle.getRolle1())) {
							Constants.LOGGER.severe(rolle.getRolle1().getName() + " already listed. Should not be!"); //$NON-NLS-1$
						}
						if (alreadyListed.contains(rolle.getRolle2())) {
							Constants.LOGGER.severe(rolle.getRolle2().getName() + " already listed. Should not be!"); //$NON-NLS-1$
						}
						if (r == 0)
							rowData.add(rolle.getRolle1().getDurchmesser());
						if (r == 1)
							rowData.add(rolle.getRolle1().getFs2());
						if (r == 2)
							rowData.add(rolle.getRolle1().getFn3());
						if (r == 3)
							rowData.add(rolle.getRolle1().getFn4());
						if (r == 4)
							rowData.add(rolle.getRolle1().isGegenbiegung());
						alreadyListed.add(rolle.getRolle1());
						if (r == 0)
							rowData.add(rolle.getRolle2().getDurchmesser());
						if (r == 1)
							rowData.add(rolle.getRolle2().getFs2());
						if (r == 2)
							rowData.add(rolle.getRolle2().getFn3());
						if (r == 3)
							rowData.add(rolle.getRolle2().getFn4());
						if (r == 4)
							rowData.add(rolle.getRolle2().isGegenbiegung());
	...
	private void fillGlobalTable(Aufzugschacht aufzugschacht, MainFrame mainFrame) {
		...
		if (aufzugschacht.getTreibscheibe() != null) {
			...
			z++;
			if (aufzugschacht.getTreibscheibe().getForm().equals(Constants.FORM_SITZ)) {
				...
				z++;
			} else if (aufzugschacht.getTreibscheibe().getForm().equals(Constants.FORM_KEIL) && aufzugschacht.getTreibscheibe().getUnterschnittwinkel() != 0) {
				globalTable.setValueAt(Messages.getString("PrintFrameMain.85"), z, 0); //$NON-NLS-1$
				globalTable.setValueAt(aufzugschacht.getTreibscheibe().getUnterschnittwinkel(), z, 1);
				z++;
			...
			if (aufzugschacht.getTreibscheibe().getRolle2teUmschlingung() != null) {
				...
				z++;
				if (aufzugschacht.getTreibscheibe().getRolle2teUmschlingung().getForm().equals(Constants.FORM_SITZ)) {
					globalTable.setValueAt(Messages.getString("PrintFrameMain.85"), z, 0); //$NON-NLS-1$
					globalTable.setValueAt(aufzugschacht.getTreibscheibe().getRolle2teUmschlingung().getUnterschnittwinkel(), z, 1);
					z++;
				} else if (aufzugschacht.getTreibscheibe().getRolle2teUmschlingung().getForm().equals(Constants.FORM_KEIL)
