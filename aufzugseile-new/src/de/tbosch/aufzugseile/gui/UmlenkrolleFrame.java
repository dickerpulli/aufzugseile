...
public class UmlenkrolleFrame extends javax.swing.JFrame implements ReactOnWarningFrame {
    ...
    /** The Logger */
    private static final Logger logger = Logger.getLogger(UmlenkrolleFrame.class.getName());
    ...
    private void setValues() {
    	...
    	horiz = ((AufzugschachtUmlenkrolle)umlenkrolle).getHorizEntf();
    	vert = ((AufzugschachtUmlenkrolle)umlenkrolle).getVertEntf();
    ...
    private boolean outsideArea(int horiz, int vert) {
    	if (aufzugschacht.getTreibscheibe() != null) {
    		int nx = ((AufzugschachtTreibscheibe)aufzugschacht.getTreibscheibe()).getMPoint().x + ((horiz) / aufzugschacht.getMmPerPixel()) + umlenkrolle.getRadius();
    		int ny = ((AufzugschachtTreibscheibe)aufzugschacht.getTreibscheibe()).getMPoint().y + ((vert) / aufzugschacht.getMmPerPixel()) + umlenkrolle.getRadius();
	...
	public void yesClicked() {
		...
		if (durchmesser > 0 
			...
			((AufzugschachtUmlenkrolle)umlenkrolle).setVertEntf(vert);
			((AufzugschachtUmlenkrolle)umlenkrolle).setHorizEntf(horiz);
			...
			((AufzugschachtUmlenkrolle)umlenkrolle).refreshSize();
			((AufzugschachtUmlenkrolle)umlenkrolle).refreshPosition();
