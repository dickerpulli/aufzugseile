 ...
 * The Class Zickzack.
 */
public class Zickzack extends JComponent implements Cloneable {
	 ...
	 * @param y_rel the relational y coordinate in percent (0 - 1)
	 */
	...
	private int getDraggingY(int oy, int dy) {
		...
		if (oy + dy >= 1 && oy + dy <= aufzugschacht.getHeight() - 1 - getHeight()) y = oy + dy;
		else if (oy + dy < 1) y = 1;
