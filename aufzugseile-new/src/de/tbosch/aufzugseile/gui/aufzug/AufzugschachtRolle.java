 ...
 */
public class AufzugschachtRolle extends AufzugschachtElement implements Rolle {
    
    /** The Logger */
    private static final Logger logger = Logger.getLogger(AufzugschachtRolle.class.getName());
	...
	protected AufzugschachtRolle rolle2teUmschlingung;
	
	/** The rolle 1te umschlingung. */
	private AufzugschachtRolle rolle1teUmschlingung;
	...
	private AufzugschachtUmlenkrolle brother;
	...
	private AufzugschachtDoppelUmlenkrolle parentDoubleRollIfExisting;
	 ...
	 * @param partOfDoppelUmlenkrolle the part of doppel umlenkrolle
	 ...
	 * @param i The path of the icon
	 */
	public AufzugschachtRolle(int x, int y, int w, int h, double s, double xs, double ys,
			String i, Aufzugschacht aufzugschacht, boolean partOfDoppelUmlenkrolle, AufzugschachtDoppelUmlenkrolle parent) {
	...
	public void setDoppelteUmschlingung(boolean doppelteUmschlingung) {
		...
		if (!this.doppelteUmschlingung && doppelteUmschlingung) {
			...
			if (this instanceof AufzugschachtTreibscheibe) {
				AufzugschachtTreibscheibe tr = (AufzugschachtTreibscheibe)this;
				rolle2teUmschlingung = new AufzugschachtTreibscheibe(tr.getX(),tr.getY(),tr.getWidth(),tr.getHeight(),1,1,1,null,(Aufzugschacht)getSchacht());
				rolle2teUmschlingung.setDurchmesser(tr.getDurchmesser());
			}
			else {
				AufzugschachtUmlenkrolle um = (AufzugschachtUmlenkrolle)this;
				rolle2teUmschlingung = new AufzugschachtUmlenkrolle(um.getX(),um.getY(),um.getWidth(),um.getHeight(),1,1,1,null,(Aufzugschacht)getSchacht(),false,null,false,null);
	...
	public void setGegenbiegung(boolean gegenbiegung) {
		if (!gegenbiegungNotChangeable) {
			...
			logger.fine("Reverse bend not setable");
		}
	}
	...
	public void setBrother(Umlenkrolle brother) {
		this.brother = (AufzugschachtUmlenkrolle)brother;
	}
	...
	public String getForm() {
		if (form == null) {
			logger.severe("getForm() is null -> form=default"); 
			form = FORM_RUND;
		}
		return form;
	}
	...
	public void setRolle1teUmschlingung(Rolle rolle1teUmschlingung) {
		this.rolle1teUmschlingung = (AufzugschachtRolle)rolle1teUmschlingung;
	}
