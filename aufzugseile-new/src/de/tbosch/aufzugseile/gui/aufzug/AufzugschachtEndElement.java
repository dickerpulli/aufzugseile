 ...
 */
public class AufzugschachtEndElement extends AufzugschachtElement implements EndElement {

	/** The rope holder. */
	private AufzugschachtSeilaufhaenger seilaufhaenger;

	/** The umlenkrolle. */
	private AufzugschachtUmlenkrolle umlenkrolle;

	/** The double umlenkrolle. */
	private AufzugschachtDoppelUmlenkrolle doppelUmlenkrolle;
	 ...
	 */
	public AufzugschachtEndElement(int x, int y, int w, int h, int sx, int sy, double s, double xs, double ys, String i, Aufzugschacht a) {
	...
	public void setSeilaufhaenger(Seilaufhaenger seilaufhaenger) {
		this.seilaufhaenger = (AufzugschachtSeilaufhaenger)seilaufhaenger;
	}
	...
	public void setUmlenkrolle(Umlenkrolle umlenkrolle) {
		this.umlenkrolle = (AufzugschachtUmlenkrolle)umlenkrolle;
	}
	...
	public void setDoppelUmlenkrolle(DoppelUmlenkrolle doppelUmlenkrolle) {
		this.doppelUmlenkrolle = (AufzugschachtDoppelUmlenkrolle)doppelUmlenkrolle;
	}
}
