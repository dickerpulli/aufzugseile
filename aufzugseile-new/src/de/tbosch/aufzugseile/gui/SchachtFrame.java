...
public class SchachtFrame extends javax.swing.JFrame {
    ...
    private void isOkay() {
    	int breite, hoehe;
    	breite = GUIHelper.getIntFromTextField(breiteTextField);
    	hoehe = GUIHelper.getIntFromTextField(hoeheTextField);
    	if (breite > 0 && hoehe >= 0) {
    		mainFrame.schachtReady(breite, hoehe);
    		dispose();
    	}
    	else {
    		errorLabel.setText("Breite oder H"+SystemConstants.OE_K+"he nicht korrekt!");
    	}
    }
}
